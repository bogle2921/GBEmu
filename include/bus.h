...
// MEMORY MAP
#define BOOT_ROM_START 0x0000  // BOOT ROM START
#define BOOT_ROM_END   0x00FF  // BOOT ROM END  
#define ROM_START      0x0000  // CARTRIDGE ROM
#define ROM_BANK       0x4000  // SWITCHABLE BANK
#define VRAM_START     0x8000  // VIDEO RAM
#define RAM_START      0xA000  // CARTRIDGE RAM
#define RAM_BANK_SIZE  0x2000  // CART RAM BANK SIZE
#define RAM_END        0xC000  // END OF CART RAM
#define WRAM_START     0xC000  // WORK RAM
#define ECHO_RAM       0xE000  // ECHO RAM
#define OAM_START      0xFE00  // SPRITE DATA
#define PROHIB_START   0xFEA0  // UNUSED
#define IO_START       0xFF00  // IO REGISTERS START
#define HMEM_START     0xFF00  // IO REGISTERS ALIAS
#define HRAM           0xFF80  // HIGH RAM
